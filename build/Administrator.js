...
class Administrator {
    async showAdminMethods() {
        ConsoleHandling_1.default.consoleLine.write("Hello Admin!" + " \n");
        let answer = await ConsoleHandling_1.default.showPossibilities(["1. Create new Vaccination Day", "2. Get the Day Overview", "3. Get the percantage of open and booked Vaccinations", "4. Get the free clock times", "5. Get complete Statistics", "6. Quit"], "Which function do you want to use? (1): ");
